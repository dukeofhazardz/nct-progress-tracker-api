...
import { avatarUrlOf } from "../../shared/profile";
...
export const register = async (data: any) => {
    if (!data.username || !data.password || !data.name) throw new Error("Name, username and password are required");
...
export const login = async ({ username, email, password }: any) => {
